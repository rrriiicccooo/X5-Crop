...
- User-facing docs are `README.md`, `快速启动_Quick_Start.md`, and
  `CHANGELOG.md`.
- Developer architecture doc is root `ARCHITECTURE.md`.
...
- Root `ARCHITECTURE.md` is the single bilingual developer architecture guide;
  no mirrored `docs/` copy is kept.
