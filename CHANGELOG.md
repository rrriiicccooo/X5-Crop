...
当前 active 脚本：`X5_Crop.py` V3.6.9
...
| 版本 | 状态 | 摘要 |
|---|---|---|
| V3.6.9 | 当前 active 开发版 | 统一 active grid protection 和 diagnostics 的轻量 hard-gap trust，减少红框可信度双轨冲突。 |
...
Current active script: `X5_Crop.py` V3.6.9
...
|---|---|---|
| V3.6.9 | Current active development | Unifies active grid protection and diagnostics around lightweight hard-gap trust, reducing the two-track red-gap trust conflict. |
