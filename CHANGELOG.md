...
当前 active 脚本：`X5_Crop.py` V3.6.6
...
| 版本 | 状态 | 摘要 |
|---|---|---|
| V3.6.6 | 当前 active 开发版 | 新增 hard gap trust、nearby separator 复查和受限的 strong separator 抗 grid 覆盖规则。 |
...
Current active script: `X5_Crop.py` V3.6.6
...
|---|---|---|
| V3.6.6 | Current active development | Adds hard-gap trust, nearby separator checks, and a limited strong-separator anti-grid-override rule. |
