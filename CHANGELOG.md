...
当前 active 脚本：`X5_Crop.py` V3.6.11
...
| 版本 | 状态 | 摘要 |
|---|---|---|
| V3.6.11 | 当前 active 开发版 | 将 `edge-pair` 扩展为 format-aware full-strip 逻辑，135 保持原参数，其它格式保守启用。 |
...
Current active script: `X5_Crop.py` V3.6.11
...
|---|---|---|
| V3.6.11 | Current active development | Extends `edge-pair` into format-aware full-strip logic; 135 keeps its original parameters, while other formats enable it conservatively. |
