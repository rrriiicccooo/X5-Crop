...
| 版本 | 状态 | 摘要 |
|---|---|---|
| V3.6 | 当前 active 开发版 | 从 V3.3.1 输出基线出发做诊断清理，新增只读红框可信度和叠片/连续内容诊断，不改变 V3.3.1 输出。 |
...
Current active script: `X5_Crop.py` V3.6
...
|---|---|---|
| V3.6 | Current active development | Diagnostic cleanup from the V3.3.1 output baseline. Adds read-only hard-gap trust and overlap/continuous-content diagnostics without changing V3.3.1 output. |
