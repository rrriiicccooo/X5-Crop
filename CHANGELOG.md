...
如果你只是使用脚本，请优先看 `README.md` 和 `快速启动_Quick_Start.md`。这份文档主要给继续调检测逻辑、比较版本、回滚或排查行为变化时使用。
...
If you only want to use the script, start with `README.md` and `快速启动_Quick_Start.md`. This document is mainly for continuing detector work, comparing versions, rolling back, or investigating behavior changes.
