...
- runtime output policy 从 finalization policy module 拆出；finalization policy module 只保留
  approved geometry adjustment，output bleed / edge-bleed protection 归 runtime output policy。
...
- Runtime output policy has been split out of the finalization policy module.
  Finalization policy keeps approved geometry adjustment; output bleed and
  edge-bleed protection belong to runtime output policy.
