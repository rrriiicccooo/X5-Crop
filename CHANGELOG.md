...
当前 active 脚本：`X5_Crop.py` V3.6.10
...
| 版本 | 状态 | 摘要 |
|---|---|---|
| V3.6.10 | 当前 active 开发版 | 低风险清理版：移除未使用函数，修正 CLI help 和诊断旧话术，不改变检测流程。 |
...
Current active script: `X5_Crop.py` V3.6.10
...
|---|---|---|
| V3.6.10 | Current active development | Low-risk cleanup: removes unused code, fixes CLI help and stale diagnostic wording, with no detection-flow change. |
