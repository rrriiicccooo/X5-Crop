...
if not defined PYTHON (
    ...
    echo The launcher needs Python with numpy, scipy, Pillow, tifffile, and imagecodecs installed.
...
%CANDIDATE% -c "import numpy, scipy, PIL, tifffile, imagecodecs" >nul 2>nul
