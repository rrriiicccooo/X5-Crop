...
- 120-66 / 120-67 已开始做更具体的参数校准：120-66 会在分隔证据可靠但短轴 outer 明显过窄时尝试短轴外框扩展；120-67 的横向画幅比例按 5:4 处理，并允许保守的 120-67 宽分隔 retry 和短轴 outer 收紧。
...
Current active script version: V4.1.2
...
- 120-66 and 120-67 now have more specific tuning: 120-66 can retry a
  short-axis outer expansion when separator evidence is reliable but the outer
  is visibly too narrow, horizontal 120-67 is handled as a 5:4 frame, and
