...
- 120-66 / 120-67 已开始做更具体的参数校准：120-66 会在分隔证据可靠但短轴 outer 明显过窄时尝试短轴外框扩展；120-67 的横向画幅比例按 5:4 处理。
...
Current active script version: V4.1
...
- 120-66 and 120-67 now have more specific tuning: 120-66 can retry a
  ...
  is visibly too narrow, and horizontal 120-67 is handled as a 5:4 frame.
