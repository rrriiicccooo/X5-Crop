...
- 120-66 / 120-67 已开始做更具体的参数校准：120-66 full 模式现在把三张 6x6 视为固定 count=3 的完整片条，并新增分隔优先 outer proposal：先从清晰的 66 黑色分隔带反推有效 outer，再交给原有 separator / edge-pair / scoring / review gate 判断；120-67 的横向画幅比例按 5:4 处理，并允许保守的 120-67 宽分隔 retry 和短轴 outer 收紧。
...
Current active script version: V4.2.2
...
- 120-66 and 120-67 now have more specific tuning: 120-66 full mode treats the
  strip as a fixed count=3 set of three 6x6 frames and adds a separator-first
