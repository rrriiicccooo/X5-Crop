...
| 黄色线 | v18 新增：由全局片距 / grid 模型推算出的切线，不代表一定看到了真实黑条 |
| 紫色线 | v18 新增：证据不足时使用的等分或宽区域 fallback 切线 |
| 白色线 | v18 新增：其它未分类的切线来源 |

debug 图左上角会显示是否通过当前置信度阈值：
