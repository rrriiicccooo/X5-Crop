...
class ParameterLegitimacyContractTest(unittest.TestCase):
    def test_invalid_physical_facts_and_execution_budgets_are_rejected(self) -> None:
        invalid_factories = (
            ...
            lambda: PhotoEdgeDetectionParameters(
                minimum_independent_observations=0
            ),
            lambda: PhotoEdgeGeometryParameters(maximum_region_cells=0),
    ...
    def test_photo_edge_and_transform_thresholds_have_distinct_owners(self) -> None:
        self.assertEqual(
            set(PhotoEdgeDetectionParameters.__dataclass_fields__),
            {
                ...
                "local_noise_floor_u8",
                "local_window_height_ratio",
                "local_window_min_px",
                "multiscale_factors",
                "minimum_supporting_scales",
                "multiscale_position_tolerance_ratio",
        ...
        self.assertEqual(
            set(TransformDetectionParameters.__dataclass_fields__),
            {
                ...
                "maximum_projected_uncertainty_photo_height_ratio",
            },
        )
