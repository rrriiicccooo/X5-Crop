...
PARAMETER_GROUPS = (
    ...
    _group(RunConfig, ("layout_auto", "copy_review_files", "export_review", "dry_run", "overwrite", "report"), ParameterRole.USER_PREFERENCE, "boolean", "runtime", "Validated user-selected runtime behavior."),
