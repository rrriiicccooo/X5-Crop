...
from ..domain import DetectionCandidate, ImageProfile, ProcessResult
...
def candidate_geometry_from_record(record: dict[str, Any]) -> DetectionCandidate:
...
def result_from_reusable_analysis(
    ...
    source_arr = arr
    detection = candidate_geometry_from_record(cached_record)
