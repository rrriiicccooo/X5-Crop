    ...
    return OuterPolicy(
        ...
        correction=OuterCorrectionPolicy(
            ...
            content_containment=ContentContainmentCorrectionPolicy(
                ...
                long_threshold_ratio=float(content_containment.long_threshold_ratio),
                long_threshold_min=int(content_containment.long_threshold_min),
                long_threshold_max=int(content_containment.long_threshold_max),
                short_threshold_ratio=float(content_containment.short_threshold_ratio),
                short_threshold_min=int(content_containment.short_threshold_min),
                short_threshold_max=int(content_containment.short_threshold_max),
                long_excess_ratio=float(content_containment.long_excess_ratio),
                long_excess_threshold_ratio=float(content_containment.long_excess_threshold_ratio),
                short_excess_ratio=float(content_containment.short_excess_ratio),
                short_requires_hard_anchors=bool(content_containment.short_requires_hard_anchors),
                short_content_height_max=float(content_containment.short_content_height_max),
                content_width_min=float(content_containment.content_width_min),
                edge_short_ratio=float(content_containment.edge_short_ratio),
                edge_dark_max=float(content_containment.edge_dark_max),
                border_band_ratio=float(content_containment.border_band_ratio),
