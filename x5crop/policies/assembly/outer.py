    ...
    return OuterPolicy(
        ...
        correction=OuterCorrectionPolicy(
            ...
            content_containment=ContentContainmentCorrectionPolicy(
                ...
                long_gate_ratio=float(content_containment.long_gate_ratio),
                long_gate_min=int(content_containment.long_gate_min),
                long_gate_max=int(content_containment.long_gate_max),
                short_gate_ratio=float(content_containment.short_gate_ratio),
                short_gate_min=int(content_containment.short_gate_min),
                short_gate_max=int(content_containment.short_gate_max),
                long_excess_ratio=float(content_containment.long_excess_ratio),
                long_gate_excess_ratio=float(content_containment.long_gate_excess_ratio),
