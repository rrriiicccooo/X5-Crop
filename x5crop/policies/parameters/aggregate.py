...
class FormatParameters(FormatParameterViews):
    ...
    overlap_bleed_risk_mean_min: float = 55.0
    overlap_bleed_risk_weak_continuity: float = 0.16
    overlap_bleed_risk_weak_activity: float = 0.04
    overlap_bleed_risk_medium_continuity: float = 0.35
    overlap_bleed_risk_medium_activity: float = 0.08
    overlap_bleed_risk_strong_continuity: float = 0.70
    overlap_bleed_risk_strong_activity: float = 0.12
    ...
    partial_safe_extra_frames_max_photo_width_cv: float = 0.055
    ...
    lucky_unstable_photo_width_cv: float = 0.006
    lucky_unstable_photo_width_weight: float = 0.16
    lucky_mild_photo_width_cv: float = 0.003
    lucky_mild_photo_width_weight: float = 0.08
    lucky_strong_hard_credit_min: int = 3
    lucky_strong_hard_credit: float = -0.15
    lucky_stable_photo_width_cv: float = 0.002
    lucky_stable_model_gap_min: int = 3
    lucky_stable_photo_width_geometry_credit: float = -0.35
