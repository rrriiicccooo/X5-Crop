...
class FormatParameterViews:
    ...
    def separator_support(self) -> SeparatorSupportParameters:
        return SeparatorSupportParameters(
            ...
            reliable_gap_min_score=self.separator_support_reliable_gap_min_score,
    ...
    def partial_holder(self) -> PartialHolderParameters:
        return PartialHolderParameters(
            enabled=self.partial_edge_safety_enabled,
            min_count_35mm=self.partial_edge_safety_min_count_35mm,
            min_count_small=self.partial_edge_safety_min_count_small,
            min_hard_gaps=self.partial_edge_safety_min_hard_gaps,
            min_hard_ratio=self.partial_edge_safety_min_hard_ratio,
            max_equal_gaps=self.partial_edge_safety_max_equal_gaps,
            max_photo_width_cv=self.partial_edge_safety_max_photo_width_cv,
            min_joint_score=self.partial_edge_safety_min_joint_score,
            min_content_score=self.partial_edge_safety_min_content_score,
            min_geometry_score=self.partial_edge_safety_min_geometry_score,
            min_broad_separator_width_gaps=self.partial_edge_safety_min_broad_separator_width_gaps,
            broad_separator_width_min_ratio=self.partial_edge_safety_broad_separator_width_min_ratio,
            leading_content_check=self.partial_edge_safety_leading_content_check,
            leading_content_max_mean=self.partial_edge_safety_leading_content_max_mean,
            leading_content_max_coverage=self.partial_edge_safety_leading_content_max_coverage,
            leading_content_band_ratio=self.partial_edge_safety_leading_content_band_ratio,
            frame_content_check=self.partial_edge_safety_frame_content_check,
            min_frame_mean=self.partial_edge_safety_min_frame_mean,
            min_frame_coverage=self.partial_edge_safety_min_frame_coverage,
        )
