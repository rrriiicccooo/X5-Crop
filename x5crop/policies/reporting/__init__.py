...
def _separator_detail(policy: "DetectionPolicy") -> dict[str, Any]:
    ...
    return {
        ...
        "gap_search_profiles": {
            ...
            "broad_width": {
                "enabled": separator.separator_width_profile_enabled,
                "max_width_ratio": separator.separator_width_profile_max_width_ratio,
                "confidence_cap": separator.separator_width_profile_confidence_cap,
            },
        },
        "separator_width_profile_enabled": separator.separator_width_profile_enabled,
        "separator_width_profile_max_width_ratio": separator.separator_width_profile_max_width_ratio,
        "separator_width_profile_confidence_cap": separator.separator_width_profile_confidence_cap,
        "width_profile": _fields(
            ...
            (
                ...
                "sample_short_axis_max",
                "sample_long_axis_max",
                "profile_smooth_short_axis_ratio",
                "profile_smooth_min",
                "min_width_ratio",
                "min_width_min",
                "min_width_max",
                ...
                "edge_margin_ratio",
                "edge_margin_min",
                "edge_margin_cap_ratio",
                "gap_window_ratio",
                "gap_window_min",
                "gap_window_floor",
                "gap_window_cap_ratio",
                "gap_distance_penalty_weight",
                "gap_score_base",
                "spacing_min_ratio",
                "spacing_max_ratio",
