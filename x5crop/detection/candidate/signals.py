...
SIGNAL_SEPARATOR_FAMILY_SUPPORT_INCOMPLETE = "separator_family_support_incomplete"
...
PHOTO_GEOMETRY_BLOCKER_SIGNALS = frozenset(
    {
...
SIGNAL_BUCKETS = {
    ...
    **{signal: "geometry" for signal in PHOTO_GEOMETRY_BLOCKER_SIGNALS},
