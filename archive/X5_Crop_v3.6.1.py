...
MODEL_GAP_METHODS = {"grid", "equal", "equal-broad-region", "content"}
...
def attach_read_only_diagnostics(gray: np.ndarray, detection: Detection) -> None:
    ...
    method_roles = {
        ...
        "equal-broad-region": "geometry_model_broad_fallback",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="X5 Crop V3.6.1 diagnostic-cleanup single-strip TIFF film cropper.")
