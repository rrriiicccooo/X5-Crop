...
class FormatTuning:
    ...
    separator_confirmed_partial_outer_enabled: bool = False
    separator_confirmed_partial_outer_count: int = 0
    separator_confirmed_partial_outer_max_candidates: int = 8
    separator_confirmed_partial_outer_margin_ratios: tuple[float, ...] = (0.00, 0.018, 0.035)
    separator_confirmed_partial_outer_source_candidates: int = 3
...
def format_tuning(format_name: str) -> FormatTuning:
    ...
    if format_name == "120-66":
        return base_120_tuning(
            ...
            separator_first_partial_mode="always",
            separator_confirmed_partial_outer_enabled=True,
            separator_confirmed_partial_outer_count=3,
            separator_confirmed_partial_outer_max_candidates=8,
            separator_confirmed_partial_outer_margin_ratios=(0.00, 0.018, 0.035, 0.055),
            separator_confirmed_partial_outer_source_candidates=3,
        )
...
class AnalysisCache:
    ...
    separator_confirmed_partial_outer_candidates: dict[tuple[Any, ...], list[OuterCandidate]] = field(default_factory=dict)
