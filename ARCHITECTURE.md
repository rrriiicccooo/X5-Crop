...
几何和 bleed；diagnostics policy 与 report policy 单独装配，confidence cap 和 review reason
不属于 finalization。
...
diagnostics and report policies are assembled separately. The only policy-construction
