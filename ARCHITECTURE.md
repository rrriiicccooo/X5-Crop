...
| Gap / separator | separator profile | `geometry/separator_profile.py` | profile 生成是否稳定，edge refine profile 是否只作为 gap evidence；中段采样、分段极端亮/暗、uniform soft score 和列向梯度已拆成独立 helper 供逐项审核。 |
