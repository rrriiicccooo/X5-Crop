...
| 逻辑族群视角 | 检测逻辑本身有哪些族群，哪些已审？ | 建立 Detection / Gate / Risk 人工审核索引，Pre-detection、outer、Gap / Separator 结构和 Content 结构已完成；outer / separator 已归入 physical，Content 已归入 guidance + evidence。 | 当前接点明确为 content consumer / candidate build。 | 进行中 | 审核 content score、selection conflict 与 frame geometry。 |
