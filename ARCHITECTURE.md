...
| Gate | separator gate | `detection/candidate/assessment/gates.py` | gate profile 是否与 format/mode policy 一致；`SeparatorGateEvidence` 统一汇总 hard / model / width / leading-grid evidence，profile helper 只消费 evidence summary 和 gate policy。 |
